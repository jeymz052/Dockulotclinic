...
export default function ContentsManagerPage() {
  ...
  if (isLoading || loading) {
    return <div className="h-40 animate-pulse rounded-3xl border border-neutral-100 bg-white shadow-sm" />;
  }

  if (!canEdit) {
    return (
      <div className="rounded-3xl border border-neutral-200 bg-neutral-50 p-6 text-sm text-neutral-800">
        ...
        <div>
          ...
          <div className="mt-6">
            <Link
              href="/"
              target="_blank"
              className="inline-flex items-center gap-2 rounded-full bg-neutral-300 px-4 py-2 text-sm font-bold text-white transition hover:bg-black"
            >
              ...
              <button
                ...
                className={`rounded-[1.35rem] px-4 py-4 text-left transition ${
                  active
                    ...
                    : "bg-slate-50 text-slate-800 hover:bg-neutral-50"
                }`}
              >
                <p className="text-sm font-black tracking-tight">{tab.label}</p>
                <p className={`mt-1 text-xs leading-5 ${active ? "text-neutral-50" : "text-slate-500"}`}>{tab.detail}</p>
              </button>
            );
          })}
        </div>
        ...
        <EditorSection title="About" note="This is the About section from the landing page navigation.">
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
            <div className="space-y-4">
              ...
              <div className="rounded-[1.5rem] border border-neutral-100 bg-neutral-50/60 p-4">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-neutral-700">About highlights</p>
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-4 py-2 text-sm font-bold text-neutral-700 transition hover:bg-neutral-50"
                  >
                    <FaPlus className="h-3 w-3" aria-hidden="true" />
                    Add card
                  </button>
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2">
                  {ensureAboutHighlights(content.about_highlights).map((item, index) => (
                    <div key={`${item.title}-${index}`} className="rounded-[1.4rem] border border-neutral-100 bg-white p-4 shadow-sm">
                      <div className="flex items-center justify-between gap-3">
                        <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-neutral-700">Card {index + 1}</p>
            ...
            <PreviewCard title="About Preview">
              <div className="rounded-[1.6rem] border border-neutral-100 bg-white p-4 shadow-sm">
                <div className="grid gap-4">
                  <div className="overflow-hidden rounded-[1.3rem] border border-neutral-100 bg-neutral-50 p-3">
                  ...
                  <div>
                    <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-neutral-700">{content.about_eyebrow}</p>
                    ...
                    <div className="mt-5 grid gap-3 sm:grid-cols-2">
                      {ensureAboutHighlights(content.about_highlights).map((item, index) => (
                        <div key={`${item.title}-${index}`} className="rounded-2xl border border-neutral-100 bg-neutral-50/50 p-4">
                          <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-neutral-700">{item.title}</p>
          ...
          <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_500px]">
            <div className="space-y-3">
              ...
              {content.services.map((service, index) => (
                <div key={`${service.title}-${index}`} className="rounded-[1.2rem] border border-neutral-100 bg-slate-50/70 p-2.5">
            ...
            <PreviewCard title="Services Preview">
              <div className="rounded-[1.7rem] border border-neutral-100 bg-neutral-50/40 p-5">
                <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-neutral-700">{content.services_eyebrow || "Services"}</p>
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  {content.services.map((service, index) => (
                    <div key={`${service.title}-${index}`} className="rounded-[1.5rem] border border-neutral-100 bg-white p-5 shadow-sm">
                      <div className="inline-flex rounded-full bg-neutral-100 px-3 py-2 text-[11px] font-bold uppercase tracking-[0.16em] text-neutral-700">
        ...
        >
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <PreviewCard title="Blog Preview">
              <div className="rounded-[1.6rem] border border-neutral-100 bg-white p-5 shadow-sm">
                <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-neutral-700">{content.blog_eyebrow ?? "Blogs"}</p>
                ...
                <div className="mt-5 grid gap-4">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="rounded-[1.3rem] border border-neutral-100 bg-neutral-50 p-4">
                      <p className="text-sm font-semibold uppercase tracking-[0.22em] text-neutral-700">{content.blog_categories_title ?? "Categories"}</p>
                      <ul className="mt-4 space-y-2">
                        {blogCategories.map((category) => (
                          <li key={category} className="border-b border-neutral-100 pb-2 text-sm font-semibold text-slate-700 last:border-b-0 last:pb-0">
                            {category}
                          </li>
                        ))}
                      </ul>
                    ...
                    <div className="rounded-[1.3rem] border border-slate-200 bg-white p-4 shadow-sm">
                      <p className="text-sm font-semibold uppercase tracking-[0.22em] text-neutral-700">{content.blog_recent_posts_title ?? "Recent Posts"}</p>
        ...
        >
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <PreviewCard title="Videos Preview">
              <div className="space-y-4">
                <div className="rounded-[1.6rem] border border-neutral-100 bg-white p-5 shadow-sm">
                  <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-neutral-700">{content.videos_eyebrow ?? "Videos"}</p>
                  ...
                  <div className="mt-5 rounded-[1.5rem] border border-slate-200 bg-white shadow-sm">
                    <div className="h-32 rounded-t-[1.5rem] bg-neutral-100" />
                    <div className="p-4">
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <PreviewCard title="Live Preview">
              <div className="rounded-[1.6rem] border border-neutral-100 bg-white p-5 shadow-sm">
                ...
                <p className="mt-4 text-[11px] font-bold uppercase tracking-[0.22em] text-neutral-700">{content.live_eyebrow}</p>
                ...
                <div className="mt-5 inline-flex rounded-full border border-neutral-200 px-4 py-2 text-sm font-bold text-neutral-700">
          ...
          <div className="space-y-5">
            ...
            <div className="grid gap-4 xl:grid-cols-3">
              {ensureTestimonials(content.testimonials).map((testimonial, index) => (
                <div key={`${testimonial.name}-${index}`} className="rounded-[1.4rem] border border-neutral-100 bg-slate-50/70 p-4">
                  <div className="mb-3 flex items-center justify-between gap-3">
                    <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-neutral-700">Card {index + 1}</p>
      ...
      {activeTab === "faq" ? (
        <EditorSection title="FAQ" note="These FAQs appear on the landing page and the public FAQ page.">
          <div className="grid gap-6 xl:grid-cols-[380px_minmax(0,1fr)]">
            <div className="rounded-[1.6rem] border border-neutral-100 bg-neutral-50/60 p-5">
            ...
            <div className="rounded-[1.6rem] border border-neutral-100 bg-white p-5 shadow-sm">
              <div className="flex flex-wrap gap-2">
                {faqGroups.map((group) => (
                  <span key={group.category} className="rounded-full border border-neutral-100 bg-neutral-50 px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-neutral-700">
                    {group.category}
                  </span>
                ))}
              </div>
              <div className="mt-5 grid gap-4 xl:grid-cols-2">
                {faqGroups.map((group) => (
                  <div key={group.category} className="rounded-[1.4rem] border border-neutral-100 bg-slate-50/70 p-4">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-neutral-700">FAQ Category</p>
                          ...
                          <div className="mt-4 space-y-3 border-t border-slate-200 pt-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              <button
                                ...
                                className="rounded-full border border-neutral-200 bg-neutral-50 px-3.5 py-1.5 text-xs font-bold text-neutral-700 transition hover:bg-neutral-100"
                              >
                                Save changes
                              </button>
                              <button
                              ...
                              <button
                                ...
                                className="rounded-full border border-neutral-200 bg-white px-3.5 py-1.5 text-xs font-bold text-neutral-700 transition hover:bg-neutral-50"
                              >
                                Delete
                              </button>
                            </div>
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <PreviewCard title="Contact Preview">
              <div className="rounded-[1.6rem] border border-neutral-200 bg-white p-5 shadow-sm">
                <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-neutral-700">{content.contact_eyebrow}</p>
...
function EditorSection({
  ...
  return (
    <section className="rounded-[2rem] border border-neutral-100 bg-white p-5 shadow-[0_16px_45px_-38px_rgba(15,23,42,0.35)] sm:p-6">
      <div className="mb-5 flex flex-wrap items-start justify-between gap-4 border-b border-neutral-100 pb-4">
        <div>
...
function PreviewCard({ title, children }: { title: string; children: ReactNode }) {
  return (
    <aside className="rounded-[1.7rem] border border-neutral-200 bg-[linear-gradient(180deg,#f8f8f7_0%,#f0f0f0_100%)] p-4">
      <p className="text-[11px] font-bold uppercase tracking-[0.24em] text-neutral-700">{title}</p>
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-1 w-full rounded-xl border border-neutral-100 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-neutral-400 focus:ring-2 focus:ring-neutral-100"
      />
    </label>
  );
}
...
function StringListEditor({
  ...
  return (
    <div className="rounded-[1.35rem] border border-neutral-100 bg-neutral-50/60 p-4">
      <div className="mb-3 flex items-center justify-between gap-3">
        <p className="inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-600">
          <FaFolderOpen className="h-3 w-3 text-neutral-700" aria-hidden="true" />
          {label}
        </p>
        <button
          type="button"
          onClick={onAdd}
          className="inline-flex items-center gap-1.5 rounded-full border border-neutral-200 bg-white px-3 py-1.5 text-xs font-bold text-neutral-700 transition hover:bg-neutral-50"
        >
        ...
        {items.map((value, index) => (
          <div key={`${value}-${index}`} className="flex items-center gap-2">
            <input
              ...
              className="flex-1 rounded-xl border border-neutral-100 bg-white px-3 py-2.5 text-sm text-slate-900 outline-none transition focus:border-neutral-400 focus:ring-2 focus:ring-neutral-100"
            />
...
function RemoveButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`rounded-full border border-neutral-200 bg-white text-neutral-600 transition hover:border-neutral-300 hover:bg-neutral-50 ${
        compact ? "p-1.5" : "p-2"
      }`}
      title={title}
    >
