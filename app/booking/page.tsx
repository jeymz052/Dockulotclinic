...
export const metadata: Metadata = {
  ...
  description:
    "Book a Doc Kulot clinic appointment or virtual consult by choosing a service, date, time, and patient record details.",
  alternates: {
    canonical: "/booking",
  },
};
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div>
          ...
          <p className="mt-4 max-w-3xl leading-8 text-slate-600">
            Select clinic visit or virtual consult, service, patient details, date, and time. Admin or staff can confirm the
            appointment from the dashboard.
          </p>
        </div>
        <div className="overflow-hidden rounded-3xl border border-yellow-100 bg-white p-3 shadow-xl">
          <BookAppointmentPage />
        </div>
      </div>
    </main>
