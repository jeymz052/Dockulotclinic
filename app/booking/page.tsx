...
export const metadata: Metadata = {
  ...
  description:
    "Book a Doc Kulot clinic appointment or virtual consult by choosing a service, date, time, and patient details.",
  alternates: {
    canonical: "/booking",
  },
};
    ...
    <main className="min-h-screen bg-yellow-50/60 px-4 py-12 sm:px-6">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-4 max-w-3xl leading-8 text-slate-600">
          Select clinic visit or virtual consult, service, date, and time. Admin or staff can confirm the appointment from
          the dashboard.
        </p>
