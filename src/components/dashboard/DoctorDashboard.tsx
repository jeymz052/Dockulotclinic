...
export default function DoctorDashboard() {
  ...
  return (
    <div className="space-y-6 pb-8">
              ...
              <div className="flex-1 max-w-2xl">
                ...
                <div className="mt-6 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-neutral-900">Queue #{nextInQueue.queueNumber}</p>
                      <p className="text-xs text-neutral-500">Position in today&apos;s queue</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
      ...
      >
        {upcoming.length === 0 ? (
          <div className="rounded-[1.75rem] border-2 border-dashed border-neutral-200 px-8 py-10 text-center">
            <p className="text-sm text-neutral-500">No upcoming appointments scheduled.</p>
          </div>
        ) : (
          <div className="space-y-3">
            {upcoming.map((appt, i) => (
