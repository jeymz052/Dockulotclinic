...
alter table public.landing_content
  ...
  add column if not exists about_subtitle text not null default 'Doc Kulot is a Family Medicine Specialist | Aesthetic Medicine doctor focused on family care, women''s health, telemedicine, and procedure-based aesthetics.',
  add column if not exists doctor_name text not null default 'Dr. Fatimah Al-Zahra T. Ditti',
  add column if not exists doctor_title text not null default 'Family Medicine Specialist | Aesthetic Medicine',
...
alter table public.landing_content
  ...
  alter column about_subtitle set default 'Doc Kulot is a Family Medicine Specialist | Aesthetic Medicine doctor focused on family care, women''s health, telemedicine, and procedure-based aesthetics.',
  alter column doctor_name set default 'Dr. Fatimah Al-Zahra T. Ditti',
  alter column doctor_title set default 'Family Medicine Specialist | Aesthetic Medicine',
...
set
  ...
  about_subtitle = 'Doc Kulot is a Family Medicine Specialist | Aesthetic Medicine doctor focused on family care, women''s health, telemedicine, and procedure-based aesthetics.',
  doctor_name = 'Dr. Fatimah Al-Zahra T. Ditti',
  doctor_title = 'Family Medicine Specialist | Aesthetic Medicine',
