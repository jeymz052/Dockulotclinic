...
create table public.doctors (
  ...
  specialty text not null default 'Family Medicine Specialist | Aesthetic Medicine',
  license_no text,
  bio text,
...
create table public.landing_content (
  ...
  about_subtitle text not null default 'Family Medicine Specialist | Aesthetic Medicine doctor focused on telemedicine, women''s health, procedure support, and practical family care.',
  doctor_name text not null default 'Dr. Fatimah Al-Zahra T. Ditti',
  doctor_title text not null default 'Family Medicine Specialist | Aesthetic Medicine',
  ...
  feature_1_body text not null default 'Family Medicine Specialist | Aesthetic Medicine',
